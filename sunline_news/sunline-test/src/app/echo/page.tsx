    ...
    <SunlineKit brand={brand}>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 bg-[var(--color-card)] p-6 rounded-xl shadow">
          <h2 className="text-xl font-bold mb-2 text-[var(--color-primary)]">Tech Spotlight</h2>
          {featured && (
            <div>
              ...
              <Link
                ...
                className="mt-4 inline-block underline text-sm text-purple-400"
              >
                Read more →
              </Link>
            </div>
      ...
      <div className="mt-10">
        <h2 className="text-xl font-semibold mb-4">AI & Tech Headlines</h2>
