...
export default async function SovereignHome({
  searchParams,
}: {
    ...
    <SunlineKit brand={brand}>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 bg-[var(--color-card)] p-6 rounded-xl shadow">
          <h2 className="text-xl font-bold mb-2 text-[var(--color-primary)]">Breaking Lead</h2>
          {featured && (
            <div>
              ...
              <Link
                ...
                className="mt-4 inline-block underline text-sm text-red-400"
              >
                Read more →
              </Link>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[var(--color-card)] p-4 rounded-xl shadow">
            <h3 className="text-lg font-semibold mb-2">Live Wire</h3>
            <Link
      ...
      <div className="mt-10">
        <h2 className="text-xl font-semibold mb-4">Top Reports</h2>
